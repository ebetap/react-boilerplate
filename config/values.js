...
const values = {
  // Featherjs server url
  feathersjsUrl: 'http://localhost:3030',
  ...
  // Split some specific node modules
  nodeModulesSpecialChuck: {
    alpha: ['react-dom', 'react-router', 'react-router-dom'],
    beta: ['history', 'engine.io-client', 'react-helmet'],
    omega: ['react-redux', '@feathersjs', 'react-async-component'],
  },
